...
//         /*
//          * User transcripts can come as partial/final.
//          * Keep only final user transcript to avoid duplicates.
//          *
//          * Agent transcripts may not always have lk.transcription_final,
//          * so do NOT block assistant messages using isFinal.
//          */
